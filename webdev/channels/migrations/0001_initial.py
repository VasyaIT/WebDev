...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter the channel name', max_length=20, verbose_name='name')),
                ('slug', models.SlugField(help_text='URL', max_length=30, unique=True, verbose_name='URL')),
                ...
                ('tag', models.ForeignKey(default='Tags are missing', help_text='Choose the search tags', on_delete=django.db.models.deletion.SET_DEFAULT, related_name='channels', to='channels.tag', verbose_name='channel tags')),
            ],
        ),
    ]
